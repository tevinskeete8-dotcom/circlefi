...
export default function AcceptInvite() {
  ...
  const C = {
    purple: "#1D4ED8", gold: "#D97706", bg: "#F8FAFC",
        ...
        {!error && !done && invite && (
          <>
            <div style={{ textAlign: "center", marginBottom: "2rem" }}>
              <div style={{ width: 56, height: 56, borderRadius: "50%", background: `linear-gradient(135deg, ${C.purple}, #3B82F6)`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.5rem", margin: "0 auto 1rem", color: "#fff", fontWeight: 800 }}>
            ...
            {!session ? (
              <div style={{ textAlign: "center" }}>
                ...
                <Link
                  ...
                  style={{ display: "block", width: "100%", padding: "0.875rem", background: `linear-gradient(135deg, ${C.purple}, #3B82F6)`, color: "#fff", borderRadius: 100, fontWeight: 700, textDecoration: "none", textAlign: "center", marginBottom: "0.75rem" }}
                >
                  Create account & join →
                </Link>
                <Link
                  to={`/login?invite=${token}`}
                  style={{ display: "block", width: "100%", padding: "0.875rem", background: "#EFF6FF", color: C.purple, borderRadius: 100, fontWeight: 600, textDecoration: "none", textAlign: "center" }}
                >
                  Log in to accept
                </Link>
              </div>
              ...
              <>
                ...
                <button
                  ...
                  disabled={accepting}
                  style={{ width: "100%", padding: "0.9rem", background: `linear-gradient(135deg, ${C.purple}, #3B82F6)`, color: "#fff", border: "none", borderRadius: 100, fontWeight: 700, fontSize: "1rem", cursor: "pointer" }}
                >
