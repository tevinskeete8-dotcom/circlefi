...
// ── Wave Mark logo ────────────────────────────────────────────────
function WaveMark({ size = 40, light = false }) {
  return (
...
export default function Landing() {
  ...
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', 'Segoe UI', system-ui, sans-serif", background: C.bg, color: C.text, overflowX: "hidden" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "2rem" }}>
          {["Features", "How it works", "Communities"].map(label => (
            <a key={label} href={`#${label.toLowerCase().replace(/ /g, "-")}`}
              style={{ fontSize: "0.85rem", fontWeight: 500, color: "rgba(255,255,255,0.7)", textDecoration: "none", transition: "color 0.2s" }}
          ...
          <a href="/signup" onClick={(e)=>{e.preventDefault();window.location.href="/signup"}} style={{
            ...
            background: C.gold, color: C.purpleDark,
      ...
      <section style={{
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 760 }}>
          ...
          <h1 style={{ ...anim(0.2), fontSize: "clamp(2.6rem, 7vw, 5.2rem)", fontWeight: 800, letterSpacing: "-2px", lineHeight: 1.05, color: "#fff", marginBottom: "1.5rem", fontFamily: "Georgia, 'Times New Roman', serif" }}>
          ...
          <div style={{ ...anim(0.5), display: "flex", alignItems: "center", gap: "1rem", flexWrap: "wrap", justifyContent: "center", marginBottom: "3.5rem" }}>
            <a href="/signup" onClick={(e)=>{e.preventDefault();window.location.href="/signup"}} style={{
              ...
              color: C.purpleDark, borderRadius: 100,
              ...
              onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = `0 14px 40px ${C.gold}60`; }}
              onMouseLeave={e => { e.currentTarget.style.transform = "none"; e.currentTarget.style.boxShadow = `0 8px 32px ${C.gold}50`; }}
            >
              Start your circle →
            </a>
            ...
            <div style={{ display: "flex" }}>
              {MEMBERS.map((m, i) => (
                <div key={m.i} style={{
                  ...
                  background: m.c, display: "flex", alignItems: "center",
        ...
        {/* Scroll hint */}
        <div style={{ position: "absolute", bottom: "2rem", left: "50%", transform: "translateX(-50%)", display: "flex", flexDirection: "column", alignItems: "center", gap: "0.4rem", animation: "scrollHint 2s ease-in-out infinite", opacity: 0.4 }}>
          <div style={{ width: 1, height: 40, background: "linear-gradient(to bottom, rgba(255,255,255,0), rgba(255,255,255,0.6), rgba(255,255,255,0))" }} />
        </div>
      </section>
        ...
        {[
          ...
          <Reveal key={i} delay={i * 0.1}>
            <div style={{
              ...
              <div style={{ fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 800, letterSpacing: "-1.5px", color: "#fff", lineHeight: 1, marginBottom: "0.4rem", fontFamily: "Georgia, serif" }}>
                {s.val.replace(/\d+/, m => <span key="n" style={{ color: C.gold }}>{m}</span>)}
                {s.val}
              </div>
              <div style={{ fontSize: "0.82rem", color: "rgba(255,255,255,0.45)", fontWeight: 400 }}>{s.label}</div>
            </div>
          </Reveal>
        ))}
      </div>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <Reveal>
            ...
            <h2 style={{ fontSize: "clamp(2rem, 4vw, 3.2rem)", fontWeight: 800, letterSpacing: "-0.75px", lineHeight: 1.1, color: C.text, marginBottom: "0.75rem", fontFamily: "Georgia, serif" }}>
              ...
              <em style={{ color: C.purple, fontStyle: "italic" }}>now with infrastructure.</em>
            </h2>
            ...
            {COMMUNITIES.map((c, i) => (
              <Reveal key={c.name} delay={i * 0.05}>
                <div style={{
                  ...
                  borderRadius: 100,
                  boxShadow: "0 2px 8px rgba(107,63,160,0.07)",
                  transition: "transform 0.2s, box-shadow 0.2s",
                  cursor: "default",
                }}
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
          <Reveal>
            ...
            <h2 style={{ fontSize: "clamp(2rem, 4vw, 3.2rem)", fontWeight: 800, letterSpacing: "-0.75px", lineHeight: 1.1, color: "#fff", marginBottom: "3rem", fontFamily: "Georgia, serif" }}>
              ...
              <em style={{ color: C.gold }}>needs to thrive.</em>
            </h2>
          </Reveal>
            ...
            {FEATURES.map((f, i) => (
              <Reveal key={f.title} delay={(i % 3) * 0.1}>
                <div style={{
                  ...
                  onMouseEnter={e => { e.currentTarget.style.background = "rgba(255,255,255,0.08)"; e.currentTarget.style.transform = "translateY(-3px)"; e.currentTarget.style.borderColor = `rgba(107,63,160,0.4)`; }}
                ...
                >
                  <div style={{ width: 44, height: 44, borderRadius: 12, background: f.bg, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.2rem", flexShrink: 0 }}>
                    {f.icon}
                  </div>
                  <div>
                    <div style={{ fontSize: "0.95rem", fontWeight: 700, color: "#fff", marginBottom: "0.4rem", letterSpacing: "-0.2px" }}>{f.title}</div>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <Reveal>
            ...
            <h2 style={{ fontSize: "clamp(2rem, 4vw, 3.2rem)", fontWeight: 800, letterSpacing: "-0.75px", lineHeight: 1.1, color: C.text, marginBottom: "3rem", fontFamily: "Georgia, serif" }}>
              Up and running<br />
              <em style={{ color: C.purple }}>in minutes.</em>
            </h2>
          </Reveal>
            ...
            {STEPS.map((s, i) => (
              <Reveal key={s.n} delay={i * 0.15}>
                ...
                >
                  ...
                  <div style={{ width: 40, height: 40, borderRadius: 12, background: `linear-gradient(135deg, ${C.purple}, ${C.purpleMid})`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1rem", color: C.gold, marginBottom: "1.25rem", fontWeight: 900 }}>
                    {s.icon}
                  </div>
                  <div style={{ fontSize: "1.1rem", fontWeight: 700, color: C.text, marginBottom: "0.5rem", letterSpacing: "-0.2px" }}>{s.title}</div>
      ...
      <section style={{
        ...
        textAlign: "center",
        background: `
          radial-gradient(ellipse 70% 60% at 50% 50%, ${C.purple}50 0%, transparent 70%),
          linear-gradient(160deg, #120821 0%, #1C1033 100%)
        `,
        position: "relative", overflow: "hidden",
      }}>
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          <Reveal>
            ...
            <h2 style={{ fontSize: "clamp(2.2rem, 5vw, 4rem)", fontWeight: 800, letterSpacing: "-1px", lineHeight: 1.1, color: "#fff", marginBottom: "1.25rem", fontFamily: "Georgia, serif" }}>
              ...
              <em style={{ background: `linear-gradient(135deg, ${C.gold}, ${C.goldBright}, ${C.teal})`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
                Yours is coming.
              </em>
            </h2>
            ...
            <a href="/signup" onClick={(e)=>{e.preventDefault();window.location.href="/signup"}} style={{
              ...
              textDecoration: "none",
              boxShadow: `0 10px 40px ${C.gold}45`,
              transition: "transform 0.2s, box-shadow 0.2s",
            }}
              onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-3px)"; e.currentTarget.style.boxShadow = `0 18px 50px ${C.gold}55`; }}
              onMouseLeave={e => { e.currentTarget.style.transform = "none"; e.currentTarget.style.boxShadow = `0 10px 40px ${C.gold}45`; }}
            >
      ...
      <footer style={{
        ...
        <div style={{ display: "flex", gap: "1.5rem" }}>
          {["Privacy", "Terms", "Contact"].map(l => (
            <a key={l} href="#" style={{ fontSize: "0.75rem", color: "rgba(255,255,255,0.3)", textDecoration: "none", transition: "color 0.2s" }}
