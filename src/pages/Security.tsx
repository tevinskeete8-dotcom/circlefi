  ...
  return (
    <div className="sec-card">
      <div className="sec-card-head">
        <div className="sec-card-icon" style={{ color: "#1ABFAD" }}>⟡</div>
        <div>
  ...
  return (
    <div className="sec-card">
      ...
      <div className="kyc-notice">
        🔐 CircleFi follows all KYC/AML requirements. Your data is encrypted and never sold.
      </div>
...
function PrivacySection() {
  ...
  const items: { key: keyof typeof prefs; title: string; desc: string; color: string }[] = [
    { key: "creditReporting", color: "#1ABFAD", title: "Credit Reporting",        desc: "Share your contribution history with credit bureaus to build your financial profile." },
    ...
    { key: "marketingEmails", color: "#7B5EA7", title: "Product Updates",         desc: "Receive emails about new CircleFi features and community finance insights." },
  ];
  ...
  return (
    <div className="sec-card">
      <div className="sec-card-head">
        ...
        <div>
          <h3>Privacy & Data</h3>
          <p>Control how your data is used across the CircleFi platform.</p>
        </div>
      </div>
  ...
  const pillars = [
    {
      ...
      desc:  "All pooled circle funds are held in custodial escrow accounts — not by CircleFi or any individual member. Your money is FDIC-insured up to applicable limits.",
    },
    {
      icon: "⚡", color: "#C9963A",
      title: "Stripe Treasury Infrastructure",
      desc:  "Payments are processed through Stripe Treasury and Unit — regulated payments infrastructure. CircleFi operates as a payments + escrow platform, not a deposit-taking institution.",
    },
    {
      icon: "🔐", color: "#7B5EA7",
  ...
  return (
    <div className="escrow-banner">
      <div className="escrow-banner-head">
        ...
        <div>
          ...
          <p className="escrow-sub">
            CircleFi is structured as payments + escrow infrastructure — not a bank.
      ...
      <div className="escrow-footnote">
        <span>🛡</span>
        <span>
          CircleFi holds no deposits and is not a bank. Funds are held in escrow by our
